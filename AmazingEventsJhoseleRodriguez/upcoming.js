...
for(let i = 0; i < data.events.length; i++){
  ...
  for (let i = 0; i < myArray.length; i++) {
    let postersUp = document.getElementById("tarjeta2")

    let postersUpcoming = document.createElement("div")
        postersUpcoming.setAttribute("class", "card")
   

    postersUpcoming.innerHTML = `<img src= ${myArray[i].image} class="card-img-top" alt="...">
