const data = {
  ...
  for (let i = 0; i < data.events.length; i++) {
    let posters = document.getElementById("tarjeta1")

    let postersHome = document.createElement("div")
        postersHome.setAttribute("class", "card")
   

    postersHome.innerHTML = `<img src= ${data.events[i].image} class="card-img-top" alt="...">
